...
dbrouter.route('/get_editions_price_list').post(datebase_Controller.get_editions_price_list);
dbrouter.route('/get_packages_list').post(datebase_Controller.get_packages_list);
dbrouter.route('/get_cat_config').post(datebase_Controller.get_category_config);
